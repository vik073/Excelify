...
export class DenseLayoutComponent implements OnInit, OnDestroy {
    ...
    get organizationName(): string {
        return 'UEX Learning Technology Pvt Ltd.';
    }
    ...
    toggleChat(quickChat): void {
        console.log('quickChat.opened 1:' + quickChat.opened);
        console.log(Object.values(quickChat));
        quickChat.toggle();
        console.log('quickChat.opened 2:' + quickChat.opened);
    }
}
