...
// App Imports
import { NODE_ENV, DATABASE_URL } from 'setup/config/env'
...
const connectWithRetry = async () => {
  return await mongoose.connect(DATABASE_URL, { useNewUrlParser: true, useCreateIndex: true, useFindAndModify: false, useUnifiedTopology: true })
}
